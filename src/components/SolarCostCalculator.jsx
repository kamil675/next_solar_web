...
const SolarCostCalculator = () => {
  ...
  return (
    <motion.div
      className="bg-[#F8F7F0] GetFontSol px-4 sm:px-6 md:px-10 lg:px-16 py-8 sm:py-10 -translate-y-[50px] sm:translate-y-0 lg:mt-[100px] move-down-200 move-down-300 move-down-350 move-down-500 move-down-600 "
      initial="hidden"
      whileInView="show"
