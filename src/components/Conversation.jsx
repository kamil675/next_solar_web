...
// Next.js way to handle images in public folder
const solarChachaImg = "/chacha.webp"; // move chacha.webp to public/
const roshniDidiImg = "/didi.webp"; // move didi.webp to public/
