...
const solarlogo = "/logo3.webp"; // must be in /public
        ...
        <div className="md:hidden bg-gray-900 mt-2 rounded-xl px-6 py-4 shadow-lg transition-all duration-300 space-y-3">
          {navLinks.map((link) => (
            <Link
              ...
              className={
                pathname === link.path
                  ? "block text-base font-medium text-orange-500 underline underline-offset-4"
                  : "block text-base font-medium text-white hover:text-orange-400"
              }
