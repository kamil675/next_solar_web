...
import FiguringOut from "@/components/FiguringOut";
import SolarCards from "@/components/SolarCards";
import ContactCards from "@/components/ContactCards";
import Footer from "@/components/Footer";
import CompanySection from "@/components/CompanySection";
import ChatUI4 from "@/components/ChatUI4";
import ScrollStackingCards from "@/components/ScrollStackingCards";
import "@/styles/ScrollStackingCards.css";
import HoverVideoCard2 from "@/components/HoverVideoCard2";
import HoverVideoCard3 from "@/components/HoverVideoCard3";
...
const im1 = "/im1.webp";
const sunImage = "/didi.webp";
const sunPhoto = "/chacha.webp";
...
export default function About() {
  return (
    <div className="bg-white text-black flex flex-col items-center mt-0 About">
      ...
      <section className="mt-1 md:mt-2 lg:mt-3 xl:mt-4 2xl:mt-5 w-full">
        <HoverVideoCard3 />
      </section>
      ...
      {/* Footer */}
      <section className="mt-16 w-full mb-0 pb-0">
        <Footer />
      </section>
    </div>
  );
