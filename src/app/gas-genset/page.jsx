          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <section>
              ...
              <p className=" text-gray-500">
                Our gas-powered gensets provide a dependable and environmentally
                friendly solution for backup power needs, ensuring uninterrupted
                electricity during outages. Designed to run on natural gas or
                LPG, these generators offer a cleaner alternative to traditional
                diesel-powered systems, significantly reducing emissions and
                promoting sustainable energy consumption. Whether for homes,
                businesses, or industrial setups, they deliver reliable power
                while maintaining efficiency
              </p>
              <p className="mt-4 text-gray-500">
                Efficiency is a key advantage of our gas gensets, as they
                provide stable and consistent energy output with optimized fuel
                consumption. Natural gas and LPG are readily available and
                cost-effective energy sources, making these gensets an
                economically viable option for those looking to lower
                operational expenses. Their ability to adapt to various
                applications ensures flexibility, whether for emergency backup,
                continuous power supply, or hybrid energy solutions.
              </p>
            </section>
