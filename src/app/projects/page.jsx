...
import { categories, projects, iconMap } from "@/components/ProjectData";
import Gallery from "@/components/Gallery";
import Footer from "@/components/Footer";
import { useRouter } from "next/navigation"; // ✅ Replaced useNavigate
import BlackWhiteGallery from "@/components/BlackWhiteGallery";
import InfiniteTiltSlider from "@/components/InfiniteTiltSlider";

const projectImage = "/pictureImage.webp";
...
const Projects = () => {
  ...
  const handleClick = () => {
    router.push("/ProjectDetails"); // ✅ Next.js navigation
  };
